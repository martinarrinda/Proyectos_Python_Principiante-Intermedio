...
while True:
    servicio = input("En que servicio quires guardar la contraseña: ")
    ...
    with open ("generador.txt", "a") as archivo:
        archivo.write(f"Servicio: {servicio} : Contraseña: {resultado_final} \n")
